...
(
	...
	CONSTRAINT FK_CTPHIEUNHAP_MAUSAC FOREIGN KEY(MAMAU) REFERENCES MAUSAC(MAMAU),
    CONSTRAINT FK_CTPHIEUNHAP_KICHCO FOREIGN KEY(MASIZE) REFERENCES KICHCO(MASIZE)
)
...
(MAPN, MAGIAY, MAMAU, MASIZE, SOLUONG, DONGIA, THANHTIEN)
VALUES
('PN001','G001','MS01','S40',50,2500000,125000000),
('PN001','G002','MS02','S42',30,2300000,69000000),

('PN002','G003','MS04','S39',100,750000,75000000),
('PN002','G008','MS03','S40',80,900000,72000000),

('PN003','G006','MS08','S42',30,1600000,48000000),
('PN003','G007','MS05','S43',25,1400000,35000000),

('PN004','G008','MS03','S40',15,1300000,19500000),
('PN004','G009','MS06','S39',20,1250000,25000000),
('PN004','G010','MS10','S41',10,1550000,15500000),

('PN005','G011','MS07','S42',25,1350000,33750000),
('PN005','G012','MS01','S40',20,1450000,29000000),
('PN005','G013','MS08','S39',15,1600000,24000000)
